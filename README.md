...
v4.1.4 updates the workflow to `android-actions/setup-android@v4`, explicitly installs only `platform-tools`, then installs the required Android 35 platform and build tools with `sdkmanager`.
...
7. After the workflow finishes, download the artifact named **FieldReady-Competency-Study-v4.1.4-APK**.
8. Extract the artifact ZIP to get `FieldReady-Competency-Study-v4.1.4.apk`.
