...
- Unified the GitHub Pages and Android application builds around one shared `web/` source directory.
- Added the Android download bridge used by CSV/JSON exports while retaining normal browser downloads on the web.
- No scoring, clinical criteria, timer, longitudinal, password-gate, MAJCOM, or installation logic changed from the synchronized web baseline.
