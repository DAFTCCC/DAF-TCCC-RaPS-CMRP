# FieldReady Longitudinal Competency Study — Web/PWA v4.1.2-synced
...
This `web/` directory is the single source of truth for both GitHub Pages and the Android wrapper in the unified repository. The Android Gradle build copies this exact directory into `app/src/main/assets/www` before every APK build. Do not hand-edit the generated Android asset copy.
